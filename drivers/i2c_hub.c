...
static struct i2c_dev_inst i2c_inst[] = {
	{
#if DT_NODE_HAS_STATUS(I2C_BUS_0, okay)
	...
	{
#if DT_NODE_HAS_STATUS(I2C_BUS_1, okay)
...
#ifdef I2C_BUS_2
	{
#if DT_NODE_HAS_STATUS(I2C_BUS_2, okay)
...
int i2c_hub_config(uint8_t instance)
{
	...
	if (i2c_inst[instance].device == NULL ||
	    !device_is_ready(i2c_inst[instance].device)) {
