 ...
 *
 * EHL_TCP_3L motherboard signal map for my_ecfw_zephyr.
 * Host is Super I/O (config 0x2E/0x2F, KBC 0x60/0x64); it does not
 * decode ACPI EC 0x62/0x66. Power GPIOs that the motherboard owns
 * (RSMRST etc.) remain stubs (EC_DUMMY_*).
 */

#ifndef __LS101X_EHL_TCP_3L_BOARD_H__
#define __LS101X_EHL_TCP_3L_BOARD_H__
...
/* Motherboard sense: SLP_S3# / PLTRST# (input only; not PWM8) */
...
/* Power / eSPI related — RSMRST and similar are motherboard-owned */
...
#endif /* __LS101X_EHL_TCP_3L_BOARD_H__ */
